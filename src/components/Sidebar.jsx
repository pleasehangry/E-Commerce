...
const Sidebar = () => {
  ...
  const activeLink = 'flex items-center gap-5 pl-4 pt-3 pb-2.5 rounded-lg bg-blue-700 text-white  text-md m-2';
      ...
      {activeMenu && (<>
        <div className="flex justify-between items-center">
          ...
          gap-3 ml-3 mt-4 flex text-xl font-extrabold tracking-tight dark:text-white text-slate-900">
            <SiShopware className="text-3xl" /> <span>Shop iik</span>
          </Link>
